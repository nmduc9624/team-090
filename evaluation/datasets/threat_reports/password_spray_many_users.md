# Alert Report: Password Spray Against Many Users

## Alert Metadata
- alert_name: Password Spray Against Many Users
...
## Summary
Many users receive failed login attempts from the same source, suggesting password spraying.
